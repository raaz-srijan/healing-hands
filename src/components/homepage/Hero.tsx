          ...
          >
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center lg:justify-start lg:pl-20 px-4">
              <div className="max-w-4xl text-white">
                ...
                <h1
                  className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-4 leading-tight drop-shadow-lg tracking-tight slide-up-fade"
                ...
                <h2
                  className="text-xl sm:text-2xl md:text-3xl font-semibold text-sky-300 mb-6 drop-shadow-md slide-up-fade"
                ...
                <p
                  className="text-lg md:text-xl text-gray-200 leading-relaxed max-w-2xl mb-8 drop-shadow-sm slide-up-fade"
                ...
                >
                  <Link
                    to="/services"
                    className="bg-sky-600 hover:bg-sky-700 text-white px-8 py-4 rounded-full font-bold transition-all transform hover:scale-105 shadow-lg shadow-sky-900/20"
                  >
                    Explore Services
                  </Link>
                  <Link
                    to="/contact"
                    className="bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/30 text-white px-8 py-4 rounded-full font-bold transition-all transform hover:scale-105"
                  >
                    Contact Us
                  </Link>
                </div>
