...
import { FaChevronRight, FaFacebook, FaHospital, FaInstagram,  FaTwitter, FaYoutube } from 'react-icons/fa'
        ...
        <div className="border-t border-gray-800 pt-8 px-4">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    ...
                    <Link to="/locations" className="hover:text-white transition-colors">Sitemap</Link>
                </div>
            </div>
        </div>
      </footer>
