...
const StatCard = ({ title, value, icon, trend, trendUp, color = "bg-sky-500" }: StatCardProps) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-md transition-all group duration-300">
