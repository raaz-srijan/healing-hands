             ...
             <div className="space-y-6 animate-fade-in-up">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">View and manage daily appointments.</p>
                    </div>
                </div>
                                    ...
                                    <tr key={apt.id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex justify-end gap-2">
                                                <button className="p-1.5 text-green-600 hover:bg-green-50 rounded transition-colors" title="Confirm">
                                                    <FaCheck />
                                                </button>
                                                <button className="p-1.5 text-red-600 hover:bg-red-50 rounded transition-colors" title="Cancel">
                                                    <FaTimes />
                                                </button>
                                            </div>
                                        </td>
