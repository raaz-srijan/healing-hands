            ...
            <div className="max-w-2xl mx-auto space-y-6 animate-fade-in-up">
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="p-6 border-b border-gray-100">
                        ...
                        <p className="text-sm text-gray-500">Update your weekly availability and shift timings.</p>
                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                                            <FaClock className="text-gray-400" /> Start Time
                                        </label>
                                        <input 
                                            type="time" 
                                            className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 outline-none transition-all"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                                            <FaClock className="text-gray-400" /> End Time
                                        </label>
                                        <input 
                                            type="time" 
                                            className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 outline-none transition-all"
