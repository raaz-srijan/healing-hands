            ...
            <div className="relative z-10 -mt-20 max-w-7xl mx-auto px-4 md:px-8 w-full mb-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-xl flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300 group cursor-pointer border border-gray-100 dark:border-slate-700">
                        ...
                        <h3 className="text-xl font-bold text-gray-800 dark:text-slate-100 mb-2">Find Location</h3>
                        <p className="text-gray-500 dark:text-slate-400 text-sm">Nearest centers to you</p>
                    </div>
                    <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-xl flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300 group cursor-pointer border border-gray-100 dark:border-slate-700">
                        ...
                        <h3 className="text-xl font-bold text-gray-800 dark:text-slate-100 mb-2">Patient Portal</h3>
                        <p className="text-gray-500 dark:text-slate-400 text-sm">Access your records</p>
                    </div>
                    <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-xl flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300 group cursor-pointer border border-gray-100 dark:border-slate-700">
                        ...
                        <h3 className="text-xl font-bold text-gray-800 dark:text-slate-100 mb-2">Urgent Care</h3>
                        <p className="text-gray-500 dark:text-slate-400 text-sm">Wait times & check-in</p>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div className="relative">
                            ...
                            />
                            <div className="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-xl z-20 max-w-xs border border-gray-50 dark:border-slate-700">
                                <p className="text-lg font-bold text-gray-800 dark:text-white mb-1">Top Rated Hospital</p>
                                <p className="text-gray-500 dark:text-slate-300 text-sm">Consistently ranked #1 for patient safety and quality care in the region.</p>
                            </div>
                        </div>
                        <div>
                             ...
                             <div className="grid grid-cols-2 gap-8 mb-8">
                                 {[
                                     ...
                                     <div key={i}>
                                         ...
                                         <p className="text-gray-600 dark:text-slate-400 font-medium">{stat.label}</p>
                                     </div>
                                 ))}
                             </div>
                        </div>
