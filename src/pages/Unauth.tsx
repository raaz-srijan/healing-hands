            ...
            <div className="text-center max-w-lg">
                ...
                <div className="flex gap-4 justify-center">
                    <button 
                        ...
                        className="inline-flex items-center gap-2 bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-800 dark:text-white px-6 py-3 rounded-lg font-bold transition-all"
                    >
                        <FaArrowLeft /> Go Back
                    </button>
                    <Link 
